// index.js — AlphaStream v24 ELITE — FIXED STARTUP VERSION (Nov 2025)
...
// CONSTANTS — MOVED UP (prevents undefined errors)
...
async function getEquity() {
  try {
    ...
    return parseFloat(r.data.equity);
  } catch { return 25000; }
}
...
async function scanAndTrade() {
  ...
  try {
    ...
    const gappersRes = await axios.get(`https://api.massive.com/v2/gappers?min_change=3&min_volume=500000&apiKey=${MASSIVE_KEY}`);
    ...
    for (const t of gappers) {
      ...
      const barsRes = await axios.get(`https://api.massive.com/v2/aggs/ticker/${t.symbol}/range/1/minute/?adjusted=true&limit=200&apiKey=${MASSIVE_KEY}`);
